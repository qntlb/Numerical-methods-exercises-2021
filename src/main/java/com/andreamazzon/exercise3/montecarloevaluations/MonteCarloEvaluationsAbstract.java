package com.andreamazzon.exercise3.montecarloevaluations;
 ...
 * on the protected double[] field monteCarloComputations, that hosts all the
 * elements of the vector. This vector is initialized and filled by the
...
public abstract class MonteCarloEvaluationsAbstract implements MonteCarloEvaluationsInterface {
	...
	/*
	 * its elements are the different values obtained by the Monte-Carlo
	 * computations
	 */
