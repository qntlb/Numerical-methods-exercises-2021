package com.andreamazzon.exercise7and8.importancesampling;
...
public class ImportanceSamplingTesting {
	...
	public static void main(String[] args) {
		...
		/*
		 * Comment on the difference of the variance: Var(h(X)) - Var(h(Y)f(Y)/g(Y)) =
		 * E[h^(X)]- E[h^1(Y)f^2(Y)/g^2(Y)] (since the expectation of the two is equal)
