...
/**
 * It tests the finite central difference approximation of the delta of a call
 * option for the Black-Scholes model. In particular, it compares the
 * approximation computing the analytical prices for the shifted initial values
...
public class FiniteDifferencesBlackScholesTest {
	...
	public static void main(String[] args) {
		...
		final int numberOfSimulations = 1000;// number of paths
